    ...
    <a type="button" data-bs-toggle="modal" data-bs-target="#komentar<?php echo $data['fotoid'] ?>">
            <div class="card bg-dark text-white">
                ...
                <div class="card-footer text-center">
                    ...
                    <a style = "text-decoration:none" type="button" class="ms-5" data-bs-toggle="modal"  data-bs-target="#komentar<?php echo $data['fotoid'] ?>"><i class="fa-regular fa-comment"></i></a>
                    <?php
