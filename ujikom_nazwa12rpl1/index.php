            ...
            <div class="card mb-2 bg-dark text-white">
                ...
                <div class="card-footer text-center">                   
                    ...
                    if (mysqli_num_rows($ceksuka) == 1) { ?>
                        <a href="./config/proseslike2.php?fotoid=<?php echo $data['fotoid'] ?>" type="submit" name="batalsuka"><i class="fa fa-heart"></i></a>
                    <?php }else{ ?>
                        <a href="./config/proseslike2.php?fotoid=<?php echo $data['fotoid'] ?>" type="submit" name="suka"><i class="fa-regular fa-heart"></i></a>
                    <?php }
                    $like = mysqli_query($koneksi, "SELECT * FROM like_foto WHERE fotoid='$fotoid'");
                    echo mysqli_num_rows($like). ' Suka';
                    ?>

                    <a style = "text-decoration:none" type="button" data-bs-toggle="modal" class="ms-5" data-bs-target="#komentar<?php echo $data['fotoid'] ?>"><i class="fa-regular fa-comment"></i></a>
                    <?php
